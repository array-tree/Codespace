...
void update(int p)
{
    t[p].max_=max(t[p<<1].max_,t[p<<1|1].max_);
}
void pushdown(int p)
{
    if (t[p].tag_cha)
    {
        t[p<<1].max_=t[p].tag_cha;
        t[p<<1].tag_cha=t[p].tag_cha;
        t[p<<1|1].max_=t[p].tag_cha;
        t[p<<1|1].tag_cha=t[p].tag_cha;
        t[p<<1].tag_add=0;
        t[p<<1|1].tag_add=0;
        t[p].tag_cha=0;
    }
    if(t[p].tag_add)
    {
        t[p<<1].max_+=t[p].tag_add;
        t[p<<1|1].max_+=t[p].tag_add;
